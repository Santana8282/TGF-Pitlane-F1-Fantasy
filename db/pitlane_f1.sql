...
-- ══ Actualizar imagen_url de todos los pilotos (fix para DBs existentes) ══
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/M/MAXVER01_Max_Verstappen/maxver01.png' WHERE `id_piloto` = 1;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/I/ISAHAD01_Isack_Hadjar/isahad01.png' WHERE `id_piloto` = 2;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/C/CHALEC01_Charles_Leclerc/chalec01.png' WHERE `id_piloto` = 3;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/L/LEWHAM01_Lewis_Hamilton/lewham01.png' WHERE `id_piloto` = 4;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/G/GEORUS01_George_Russell/georus01.png' WHERE `id_piloto` = 5;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/v1740000001/common/f1/2026/mercedes/andant01/2026mercedesandant01right.webp' WHERE `id_piloto` = 6;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/L/LANNOR01_Lando_Norris/lannor01.png' WHERE `id_piloto` = 7;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/O/OSCPIA01_Oscar_Piastri/oscpia01.png' WHERE `id_piloto` = 8;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/F/FERALO01_Fernando_Alonso/feralo01.png' WHERE `id_piloto` = 9;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/L/LANSTR01_Lance_Stroll/lanstr01.png' WHERE `id_piloto` = 10;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/P/PIEGAS01_Pierre_Gasly/piegas01.png' WHERE `id_piloto` = 11;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/F/FRACOL01_Franco_Colapinto/fracol01.png' WHERE `id_piloto` = 12;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/A/ALEALB01_Alexander_Albon/alealb01.png' WHERE `id_piloto` = 13;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/C/CARSAI01_Carlos_Sainz/carsai01.png' WHERE `id_piloto` = 14;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/v1740000001/common/f1/2026/racingbulls/arvlin01/2026racingbullsarvlin01right.webp' WHERE `id_piloto` = 15;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/L/LIALAW01_Liam_Lawson/lialaw01.png' WHERE `id_piloto` = 16;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/O/OLIBEA01_Oliver_Bearman/olibea01.png' WHERE `id_piloto` = 17;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/E/ESTOCO01_Esteban_Ocon/estoco01.png' WHERE `id_piloto` = 18;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/N/NICHUL01_Nico_Hulkenberg/nichul01.png' WHERE `id_piloto` = 19;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/G/GABBOR01_Gabriel_Bortoleto/gabbor01.png' WHERE `id_piloto` = 20;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/S/SERPER01_Sergio_Perez/serper01.png' WHERE `id_piloto` = 21;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/V/VALBOT01_Valtteri_Bottas/valbot01.png' WHERE `id_piloto` = 22;

-- ══ Insertar pilotos faltantes si no existen ══
INSERT IGNORE INTO `pilotos` (`id_piloto`,`nombre`,`numero`,`nacionalidad`,`id_escuderia`,`precio`,`imagen_url`) VALUES
(1,'Max Verstappen',3,'Neerlandés',1,28000000,'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/M/MAXVER01_Max_Verstappen/maxver01.png'),
(2,'Isack Hadjar',6,'Francés',1,9000000,'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/I/ISAHAD01_Isack_Hadjar/isahad01.png'),
(3,'Charles Leclerc',16,'Monegasco',2,24000000,'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/C/CHALEC01_Charles_Leclerc/chalec01.png'),
(4,'Lewis Hamilton',44,'Británico',2,22000000,'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/content/dam/fom-website/drivers/L/LEWHAM01_Lewis_Hamilton/lewham01.png'),
...
-- ══ Fix imagen_url pilotos nuevos 2026 (Antonelli y Lindblad) ══
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/v1740000001/common/f1/2026/mercedes/andant01/2026mercedesandant01right.webp' WHERE `id_piloto` = 6;
UPDATE `pilotos` SET `imagen_url` = 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_1320/v1740000001/common/f1/2026/racingbulls/arvlin01/2026racingbullsarvlin01right.webp' WHERE `id_piloto` = 15;
