...
$coloresEscuderia = [
    ...
    'Cadillac Formula 1 Team'       => '#004B9D',
];
...
$fotosPilotos = [
    'Max Verstappen'         => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/M/MAXVER01_Max_Verstappen/maxver01.png',
    'Liam Lawson'            => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/L/LIALAW01_Liam_Lawson/lialaw01.png',
    'Charles Leclerc'        => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/C/CHALEC01_Charles_Leclerc/chalec01.png',
    'Lewis Hamilton'         => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/L/LEWHAM01_Lewis_Hamilton/lewham01.png',
    'George Russell'         => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/G/GEORUS01_George_Russell/georus01.png',
    'Andrea Kimi Antonelli'  => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/A/ANDANT01_Andrea_Kimi_Antonelli/andant01.png',
    'Lando Norris'           => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/L/LANNOR01_Lando_Norris/lannor01.png',
    'Oscar Piastri'          => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/O/OSCPIA01_Oscar_Piastri/oscpia01.png',
    'Fernando Alonso'        => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/F/FERALO01_Fernando_Alonso/feralo01.png',
    'Lance Stroll'           => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/L/LANSTR01_Lance_Stroll/lanstr01.png',
    'Sergio Pérez'           => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/S/SERPER01_Sergio_Perez/serper01.png',
    'Jack Doohan'            => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/J/JACDOO01_Jack_Doohan/jacdoo01.png',
    'Arvid Lindblad'         => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/A/ARVLIN01_Arvid_Lindblad/arvlin01.png',
    'Carlos Sainz'           => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/C/CARSAI01_Carlos_Sainz/carsai01.png',
    'Carlos Sainz Jr.'       => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/C/CARSAI01_Carlos_Sainz/carsai01.png',
    'Yuki Tsunoda'           => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/Y/YUKTSU01_Yuki_Tsunoda/yuktsu01.png',
    'Isack Hadjar'           => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/I/ISAHAD01_Isack_Hadjar/isahad01.png',
    'Oliver Bearman'         => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/O/OLIBEA01_Oliver_Bearman/olibea01.png',
    'Franco Colapinto'       => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/F/FRACOL01_Franco_Colapinto/fracol01.png',
    'Nico Hülkenberg'        => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/N/NICHUL01_Nico_Hulkenberg/nichul01.png',
    'Valtteri Bottas'        => 'https://media.formula1.com/image/upload/f_auto,c_limit,q_auto,w_180/content/dam/fom-website/drivers/V/VALBOT01_Valtteri_Bottas/valbot01.png',
];
?>
...
<?php foreach ($todosPilotos as $p):
    ...
    if ($foto) $foto = preg_replace('/w_\d+/', 'w_180', $foto);
    ...
    <div class="mercado-card <?= $fichado ? 'mercado-card-fichado' : '' ?>" style="border-left: 5px solid <?= htmlspecialchars($color) ?>;">
        ...
        <div class="mercado-foto-wrap">
            <?php if ($foto): ?>
                ...
                <div class="mercado-foto-placeholder" style="display:none;"><?= (int)$p['numero'] ?></div>
            <?php else: ?>
                <div class="mercado-foto-placeholder"><?= (int)$p['numero'] ?></div>
            <?php endif; ?>
            <div class="mercado-foto-overlay"></div>
            <?php if ($fichado): ?>
                <span class="mercado-badge-sobre-foto fichado">✓ En tu equipo</span>
            <?php endif; ?>
        </div>
        ...
        <div class="mercado-card-body">
            ...
            <div class="mercado-card-footer">
                <?php if ($fichado): ?>
                    <span class="mercado-badge-fichado">✓ Fichado</span>
