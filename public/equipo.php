<?php
// ============================================================
// equipo.php — Mi Equipo
// Permite al usuario ver, añadir y quitar pilotos de su equipo
// ============================================================
...
// ── Obtener el equipo fantasy del usuario ────────────────────
...
if (!$equipo) {
    die("Error: no se encontró tu equipo fantasy.");
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // ── ASIGNAR PILOTO A UN SLOT (desde la plantilla) ────────
    if ($accion === 'añadir' && $idPiloto > 0 && in_array($slot, [1, 2])) {
        ...
        if (!$piloto) {
            ...
            // Verificar que el piloto está en la plantilla del equipo
            ...
            if (!$stmtCheck->fetch()) {
                ...
                // Comprobar si ya está en el otro slot
                $otroSlot = $slot === 1 ? 2 : 1;
    ...
    // ── FICHAR PILOTO (añadirlo a la plantilla) ──────────────
    ...
    // ── LIBERAR PILOTO (quitarlo de la plantilla) ────────────
        ...
        if ($stmtDel->rowCount() > 0 && $piloto) {
            ...
            // Quitar de slots activos si estaba asignado
...
// ── Datos actualizados tras procesar el POST ─────────────────
...
// Helper: buscar piloto por ID en un array
...
// Colores oficiales por escudería
$coloresEscuderia = [
...
<div class="pilotos-grid">
    ...
    <div class="piloto-card">
        <div class="piloto-foto-wrap">
            ...
            <?php else: ?>
            <div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;font-size:36px;font-weight:900;color:#222;font-style:italic;">
                <?= (int)$p['numero'] ?>
            </div>
            <?php endif; ?>
